...
export default class Tab extends Component {
    ...
    _animateFixedInactiveToActive = () => {
        console.log('_animateFixedInactiveToActive');
        const duration = 266
    ...
    _animateFixedActiveToInactive = () => {
        console.log('_animateFixedActiveToInactive');
    ...
    _animateShiftingInactiveToActive = () => {
        console.log('_animateShiftingInactiveToActive');
        ...
        Animated.parallel([
            ...
            Animated.timing(this.state.shifting.labelOpacity,
                {toValue: 1, duration: 10, delay: 0, easing, useNativeDriver}),
    ...
    _animateShiftingActiveToInactive = () => {
        console.log('_animateShiftingActiveToInactive');
        ...
        Animated.parallel([
            ...
            Animated.timing(this.state.shifting.labelOpacity,
                {toValue: 0, duration: 10, easing, useNativeDriver}),
            Animated.timing(this.state.shifting.labelScale,
    ...
    _handleTabPress = () => {
        ...
        this.setTabActive({updateActiveTab: true})
    }

    setTabActive = ({updateActiveTab = true, forceAnimation = true}) => {
